...
source "$here/../functions/_claude_projects_root.fish"
...
@test "emits id/title/cwd/path/mtime/body" (count $p) -eq 6
...
@test "indexes the transcript body" (string match -q '*envoy timeout*' (string lower -- "$p[6]"); and echo yes) = yes
